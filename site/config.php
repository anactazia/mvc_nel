...
* Define menus.
*
* Create hardcoded menus and map them to a theme region through $nel->config['theme'].
*/
$nel->config['menus'] = array(
  'navbar' => array(
...
* Template files can reside in the parent or current theme, the CNel::ThemeEngineRender()
...
*
* path: Path to current theme, relativly NEL_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
