...
<div class='box'>
<h4>Nel core</h4>
<p>Nel core modules.</p>
<ul>
<?php foreach($modules as $module): ?>
<?php if($module['isNelCore']): ?>
<li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
<?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>Nel CMF</h4>
<p>Nel Content Management Framework (CMF) modules.</p>
<ul>
<?php foreach($modules as $module): ?>
<?php if($module['isNelCMF']): ?>
<li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
<?php endif; ?>
<?php endforeach; ?>
</ul>
...
<div class='box'>
<h4>More modules</h4>
<p>Modules that does not implement any specific Nel interface.</p>
<ul>
<?php foreach($modules as $module): ?>
<?php if(!($module['isController'] || $module['isNelCore'] || $module['isNelCMF'])): ?>
<li><a href='<?=create_url("module/view/{$module['name']}")?>'><?=$module['name']?></a></li>
<?php endif; ?>
<?php endforeach; ?>
</ul>
