<?php
/**
* A model for managing Nel modules.
*
* @package NelCore
*/
...
* Properties
*/
  private $lydiaCoreModules = array('CNel', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isNelCore'] = in_array($rc->name, $this->lydiaCoreModules);
      $details['isNelCMF'] = in_array($rc->name, $this->lydiaCMFModules);
